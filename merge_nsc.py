...
from legacyutils.ADB import ContactNamespace as c
from legacyutils.ADB import AccountNamespace as a
...
def main(nsc, db_flag, enr, con, acc):
    ...
    #nsc_enr.add_column('CName',[acc_dict[x] for x in nsc_enr.get_column(e.College__c)])
